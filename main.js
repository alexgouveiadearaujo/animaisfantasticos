...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"initBackground\": () => (/* binding */ initBackground)\n/* harmony export */ });\nfunction initBackground() {\n  var button = document.querySelector('[data-menu=\"list\"] button');\n\n  function activeBackground() {\n    var ativar = button.classList.toggle('ativo');\n\n    if (ativar) {\n      document.body.classList.add('mudarBg');\n      button.textContent = 'Lumos';\n    } else {\n      document.body.classList.remove('mudarBg');\n      button.textContent = 'Nox';\n    }\n  }\n\n  button.addEventListener('click', activeBackground); // setTimeout(() => button.addEventListener('click', activeBackground)) ;\n} // const a = document.querySelectorAll('.js_menu a');\n// const button = a[a.length - 1]\n// function activeBackground() {\n//     const ativar = button.classList.toggle('ativo');\n//     if (ativar) {\n//         document.body.classList.add('mudarBg');\n//         button.textContent = 'Lumos';\n//     }\n//     else {\n//         document.body.classList.remove('mudarBg');\n//         button.textContent = 'Nox';\n//     }\n// };\n// button.addEventListener('click', activeBackground);\n\n//# sourceURL=webpack://animaisfantasticos/./js/modules/background.js?");
